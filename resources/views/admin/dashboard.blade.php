...
@section('title', 'Dashboard | Desa Gonoharjo')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="jumbotron">
                            ...
                            <p class="lead">Terwujudnya Desa Gonoharjo yang aman, sehat, cerdas, berbudaya, berakhlaq mulia dan berdaya saing menuju pelayanan yang cepat dan tepat</p>
                            <hr class="my-4">
