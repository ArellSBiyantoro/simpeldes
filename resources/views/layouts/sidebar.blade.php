<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="{{ route('dashboard.admin') }}" class="brand-link">
        <img src="{{ asset('img/kg.png') }}" alt="Logo Desa Gonoharjo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Desa Gonoharjo</span>
    </a>
