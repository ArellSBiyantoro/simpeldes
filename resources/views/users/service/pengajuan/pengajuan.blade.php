...
@section('content')
    ...
    <div class="p-5">
        ...
        <form method="POST" action="{{ route('pengajuan.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="file_berkas" class="mb-3">Upload File Pendukung (Multiple)</label>
                <input type="file" class="form-control form-control-lg rounded-pill text-md @if ($errors->has('file_berkas')) is-invalid @endif" id="file_berkas" name="file_berkas[]" multiple value="{{ old('file_berkas') }}" placeholder="Masukkan file anda" accept="image/*,application/pdf">
